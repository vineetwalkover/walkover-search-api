...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelObject', 'model/SearchParameters'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ModelObject'), require('../model/SearchParameters'));
  } else {
    // Browser globals (root is window)
    if (!root.UniversalSearchEngine) {
      root.UniversalSearchEngine = {};
    }
    root.UniversalSearchEngine.SearchApi = factory(root.UniversalSearchEngine.ApiClient, root.UniversalSearchEngine.ModelObject, root.UniversalSearchEngine.SearchParameters);
  }
}(this, function(ApiClient, ModelObject, SearchParameters) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/SearchApi~addIndexCallback
     ...
     * @param {module:api/SearchApi~addIndexCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/SearchApi~addObjectCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} API_KEY API_KEY for authentication
     * @param {module:model/ModelObject} _object This is the single object to be add in index.
     * @param {module:api/SearchApi~addObjectCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
     ...
     * @callback module:api/SearchApi~addObjectsCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SearchApi~addObjectsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
     ...
     * @callback module:api/SearchApi~copyIndexConfigCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SearchApi~copyIndexConfigCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    ...
    /**
     * Callback function to receive the result of the deleteAllData operation.
     * @callback module:api/SearchApi~deleteAllDataCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} indexName name of index
     * @param {String} API_KEY API_KEY for authentication
     * @param {module:api/SearchApi~deleteAllDataCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteAllData = function(indexName, API_KEY, callback) {
      var postBody = null;

      // verify the required parameter 'indexName' is set
      if (indexName === undefined || indexName === null) {
        throw new Error("Missing the required parameter 'indexName' when calling deleteAllData");
      }

      // verify the required parameter 'API_KEY' is set
      if (API_KEY === undefined || API_KEY === null) {
        throw new Error("Missing the required parameter 'API_KEY' when calling deleteAllData");
      }
      ...
      return this.apiClient.callApi(
        '/deleteAllData/{index_name}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:api/SearchApi~deleteObjectCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SearchApi~deleteObjectCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
     ...
     * @callback module:api/SearchApi~generateEventCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ModelObject} _object This is the single object to be add in index.
     * @param {module:api/SearchApi~generateEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    ...
    /**
     * Callback function to receive the result of the getAllIndices operation.
     * @callback module:api/SearchApi~getAllIndicesCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} API_KEY API_KEY for authentication
     * @param {module:api/SearchApi~getAllIndicesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.getAllIndices = function(API_KEY, callback) {
      var postBody = null;

      // verify the required parameter 'API_KEY' is set
      if (API_KEY === undefined || API_KEY === null) {
        throw new Error("Missing the required parameter 'API_KEY' when calling getAllIndices");
      }
     ...
     * @callback module:api/SearchApi~getAllObjectsCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} index 
     * @param {String} API_KEY API_KEY for authentication
     * @param {module:api/SearchApi~getAllObjectsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
     ...
     * @callback module:api/SearchApi~searchQueryCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.userToken userToken for personalization
     * @param {module:model/SearchParameters} opts.searchParameters The user to create.
     * @param {module:api/SearchApi~searchQueryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
