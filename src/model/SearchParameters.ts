...
(function(root, factory) {
   ...
   * @param {module:SearchParameters} obj Optional instance to populate.
   * @return {module:SearchParameters} The populated <code>SearchParameters</code> instance.
   */
